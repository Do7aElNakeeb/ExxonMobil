...
//    public static final MediaType JSON = MediaType.parse("application/json; charset=utf-8");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextMobile.setText(prefs.getString("mobile", ""));
        editTextPassword.setText(prefs.getString("password", ""));
        editTextCarBrand.setText(prefs.getString("carBrand", ""));
        editTextCarModel.setText(prefs.getString("carModel", ""));
        editTextCarYear.setText(prefs.getString("carYear", ""));
    ...
    private void registerUser(final String name, final String email, final String mobile, final String password, final String carBrand, final String carModel, final String carYear, final String regID){
        ...
        StringRequest strReq = new StringRequest(com.android.volley.Request.Method.POST, AppConfig.URL_UPDATE, new Response.Listener<String>() {
